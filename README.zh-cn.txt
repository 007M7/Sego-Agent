...
每一次 Sego 审查都会在 `.sego/reviews/` 下写入机器可读和人类可读的证明产物（artifacts）：

- `review-<id>.json` — 机器可读的审查产物
- `review-<id>.md` — 人类可读的报告
- `index.jsonl` — 仅追加索引，方便 AI Agent 查找审查历史
...
详情请参阅 [`docs/REVIEW_ARTIFACT_CONTRACT.md`](docs/REVIEW_ARTIFACT_CONTRACT.md) 了解公共字段契约，以及 [`docs/AGENT_REVIEW_HANDOFF.md`](docs/AGENT_REVIEW_HANDOFF.md) 了解推荐的 Agent 移交工作流。
