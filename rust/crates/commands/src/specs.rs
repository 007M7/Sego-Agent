//! The slash-command catalogue: the spec table and its entry type.
//!
//! Moved out of `lib.rs` (DEV-STRUCT-01). It is pure data - a thousand lines of
//! it - and it was a third of the file, which is why it goes first: nothing here
//! depends on the rest of the crate, and the parsing and rendering code that
//! consumes it is easier to read without it.
