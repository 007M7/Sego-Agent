...
\node[stage, right=14mm of gen] (diff) {git staged diff\\ \footnotesize 明确审查范围};
\node[stage, right=14mm of diff, fill=blue!14] (review) {\textbf{sego review}\\ \footnotesize 受约束模型审查};
\node[gate,  right=16mm of review] (gate) {Evidence Gate\\ \footnotesize 确定性逐条校验};
...
\node[human, right=10mm of art] (human)
...
\begin{scope}[on background layer]
  \node[draw=black!15, dashed, rounded corners=3pt, fill=black!2,
        ...
        label={[font=\footnotesize\itshape, text=black!60]above:审查流水线（本地执行）}] {};
\end{scope}
